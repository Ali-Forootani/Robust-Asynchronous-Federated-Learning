...
def main(log_x=False):
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "test_loss_mnist.png",
        out_pdf=RESULTS_DIR / "test_loss_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "test_acc_mnist.png",
        out_pdf=RESULTS_DIR / "test_acc_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "server_training_loss_mnist.png",
        out_pdf=RESULTS_DIR / "server_training_loss_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "zeta_t_mnist.png",
        out_pdf=RESULTS_DIR / "zeta_t_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "gamma_t_mnist.png",
        out_pdf=RESULTS_DIR / "gamma_t_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "tau_bar_mnist.png",
        out_pdf=RESULTS_DIR / "tau_bar_mnist.pdf",
        log_x=log_x
    )
