...
def main(log_x=False):
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "test_loss_fashion_mnist.png",
        out_pdf=RESULTS_DIR / "test_loss_fashion_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "test_acc_fashion_mnist.png",
        out_pdf=RESULTS_DIR / "test_acc_fashion_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "server_training_loss_fashion_mnist.png",
        out_pdf=RESULTS_DIR / "server_training_loss_fashion_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "zeta_t_fashion_mnist.png",
        out_pdf=RESULTS_DIR / "zeta_t_fashion_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "gamma_t_fashion_mnist.png",
        out_pdf=RESULTS_DIR / "gamma_t_fashion_mnist.pdf",
        log_x=log_x
    )
    ...
    save_lineplot(
        ...
        out_png=RESULTS_DIR / "tau_bar_fashion_mnist.png",
        out_pdf=RESULTS_DIR / "tau_bar_fashion_mnist.pdf",
        log_x=log_x
    )
