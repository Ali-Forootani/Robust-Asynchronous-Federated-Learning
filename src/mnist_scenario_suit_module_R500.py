...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  9 06:23:00 2026
...
BASE_DIR = Path(
    "/home/forootani/Documents/ReSTEP/RAFL_revision/geany_sim/results_rafl_mnist_suite"
)
...
def save_scenario_csvs_R500(base_dir=BASE_DIR):
    ...
    print("Reporting suites with R=500:")
    print(df_R500["reporting_suite"].value_counts())

    out_dir = base_dir / "mnist_csv_for_latex_R500"
    ...
    for suite_name, sdf in df_R500.groupby("reporting_suite"):
