...
#SBATCH --job-name=my_brafl_mnist
...
python /data/bio-eng-llm/Robust_AFL_non_convex/Robust_AFL_non_convex_non_iid-main/src/baseline_robust_async_fdl_mnist_delay_track_lr_non_iid_10.py
