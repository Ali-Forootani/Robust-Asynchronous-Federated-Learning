...
from wind_trainer import (Trainer, RNNTrainer,
                          ...
                          StronglyConvexLoss,
                          train_random_clients_with_strong_convexity,
                          federated_learning_with_random_client_selection,
...
for i, (client_coords, ith_client_data) in enumerate(client_data):
    ...
    test_loader) = client_instance.prepare_data_random(test_data_size=0.9999)
...
(clients_models,
 ...
 clients_test_loaders,
 num_rounds=1,
 local_epochs=5,  # Add local_epochs here
 min_clients_per_round=1,
 max_clients_per_round=5,
 aggregation_method='weighted_average',
 loss_fn=None,
...
async def main():
    server_model, training_losses = await federated_learning_with_balanced_client_selection(
        clients_models=clients_models,
...
# Example usage
plot_client_losses(num_clients=5)
