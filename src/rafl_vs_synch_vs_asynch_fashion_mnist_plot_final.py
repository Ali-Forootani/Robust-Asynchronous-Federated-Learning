...
# -*- coding: utf-8 -*-
"""
Created on Sun Sep 14 10:14:05 2025
...
# =======================
ASYNC_LOSSES = BASE / "results_rafl" / "async_fashion_mnist_clients_10_rounds_500_epochs_3_clients_per_round_5_20250916_071324_updated" / "server_losses.npy"
SYNC_LOSSES  = BASE / "results_rafl" / "brafl_fmnist_clients_10_rounds_500_epochs_3_cpr_5_agg_stale_mean_20250916_233020_updated" / "server_losses.npy"
RAFL_LOSSES  = BASE / "results_rafl" / "rafl_fashion_mnist_clients_10_rounds_500_epochs_3_clients_per_round_5_20250915_202739_updated" / "server_losses.npy"

# Where to save the figure
OUT_DIR = BASE / "results"
SAVE_BASENAME = "nonconvex_fashion_mnist_server_losses_comparison_with_rafl"
...
def main(max_points=1000, log_x=True):
    ...
    plt.title("Fashion-MNIST Server Loss", fontsize=18)
    #plt.yscale("log")
    if log_x:
        plt.xscale("log")
